...
unset($__errorArgs, $__bag); ?>" type="file" name="cv"
                                    id="cv">
                                <?php $__errorArgs = ['cv'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tugas najra\modul_10_pf\resources\views/employee/edit.blade.php ENDPATH**/ ?>